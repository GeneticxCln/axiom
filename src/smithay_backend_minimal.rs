...
impl AxiomSmithayBackendMinimal {
    ...
    pub async fn render_frame(&mut self) -> Result<()> {
        ...
        if self.frame_count % 600 == 0 { // Every 10 seconds at 60fps
            info!("🎨 Phase 6.1 rendering - Frame #{}, time: {:.1}ms, layouts: {}", 
                  self.frame_count, 
            ...
            info!("  🌊 Workspace: column {}, position {:.1}, {} total, scrolling: {}", 
    ...
    pub fn create_test_window(&mut self, title: String) -> u64 {
        ...
        info!("✅ Phase 6.1: Test window {} added to all Axiom systems", window_id);
        window_id
    }
    ...
    pub fn remove_test_window(&mut self, window_id: u64) {
        ...
        info!("✅ Phase 6.1: Test window {} removed from all systems", window_id);
    }
